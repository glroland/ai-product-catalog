...
from graph.customer_visit import invoke_customer_visit_graph, build_customer_visit_graph
...
def inquiry_by_customer(user_input, client_id):
    ...
    graph_state = invoke_customer_visit_graph(customer_visit_graph, graph_input, client_id)
    return graph_state
