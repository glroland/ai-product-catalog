...
def clarify_customer_requirements_action(message_with_history):
    ...
    messages = [
        SystemMessage(content="""
            ...
            Your response must be in JSON format with two field enclosed indouble quotes.  Nothing can be before or after the JSON data structure.  The first field is called "Response" and is your message to the customer.  The second field is called "Attributes" and are the key characteristics you have gathered for the shoes the customer is looking for.  
                              
            Here are example responses:
        
            { "Response": "What color would you like your shoes to be?", "Attributes": "For teenage boy" }
            
            { "Response": "Thank you for confirming that you are looking for basketball shoes for weekend pickup games that have straps and were a popular design from the 1990's.", "Attributes": "Playing basketball games, with straps, and a retro look" }
                      
            { "Response": "What color would you like your shoes to be?", "Attributes": "Playing basketball games, with straps, and a retro look" }
